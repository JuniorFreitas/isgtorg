...
(function ($) {
        ...
        resetFileStack: function () {
            ...
            self.$preview.find('.file-preview-frame').each(function () {
                ...
                if (file !== undefined) {
                    ...
                    $thumb.attr('data-fileindex', 'none');
                }
            });
    ...
    $.fn.fileinput.defaults = {
        ...
        browseLabel: 'Selecionar &hellip;',
        browseIcon: '<i class="glyphicon glyphicon-folder-open"></i> &nbsp;',
        browseClass: 'btn btn-primary',
        removeLabel: 'Remove',
        removeTitle: 'Apagar arquivo selecionado',
        ...
        msgFileNotReadable: 'O arquivo "{name}" não é legível.',
        msgFilePreviewAborted: 'Pré-visualização do arquivo abortada para "{name}".',
        msgFilePreviewError: 'Ocorreu um erro ao ler o arquivo "{name}".',
        msgInvalidFileType: 'Tipo inválido para o arquivo "{name}". apenas "{types}" arquivos são suportados.',
        msgInvalidFileExtension: 'Extensão inválido para do arquivo "{name}". apenas "{extensions}" arquivos são suportados.',
        msgValidationError: '<span class="text-danger"><i class="glyphicon glyphicon-exclamation-sign"></i> File Upload Error</span>',
        msgErrorClass: 'file-error-message',
        msgLoading: 'Carregando o arquivo {index} de {files} &hellip;',
        msgProgress: 'Carregando o arquivo {index} de {files} - {name} - {porcento}% completp.',
        msgSelected: '{n} Arquivo Selecionado',
        ...
        dropZoneTitle: 'Arraste as imagens e solte aqui! &hellip;',
